...
# Shows room options to the customer and gets their choice
# Returns a number between 1 and 4 based on what they select
def Room_selection():
...
def DeliverRoom():
    ...
    return final_price
# Returns a success message after the room is booked
